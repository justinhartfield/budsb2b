...
export const existingLoyaltyPage = {
  ...
  objections: [
    {
      ...
      solution: "Buds ersetzt es nicht – wir erweitern es",
      details:
  ...
  reward_choice: {
    title: "Sie bestimmen, welche Belohnungen Ihre Kunden sehen",
    subtitle: "Drei flexible Optionen, die zu Ihrer Geschäftsstrategie passen",
    choices: [
      {
  ...
  integration_modes: {
    title: "So funktioniert Buds mit Ihrem bestehenden Programm",
